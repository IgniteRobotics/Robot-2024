...
public class PhotonCameraWrapper {
    ...
    public PhotonCameraWrapper() {
        ...
        photonPoseEstimatorLeft = new PhotonPoseEstimator(layout, PoseStrategy.MULTI_TAG_PNP_ON_RIO, photonCameraLeft, CameraConstants.photonCameraTransformLeft);
        photonPoseEstimatorRight = new PhotonPoseEstimator(layout, PoseStrategy.MULTI_TAG_PNP_ON_RIO, photonCameraRight, CameraConstants.photonCameraTransformRight);
    }
