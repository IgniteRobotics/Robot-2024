...
public class RobotContainer implements Logged {
  ...
  private DoublePreference shooterHighPower = new DoublePreference("shooter/highPower", 78);
   ...
   private DoublePreference m_kRotationalSlewRate = new DoublePreference("Rotational Slew Rate", Constants.DriveConstants.kRotationalSlewRate);
    ...
    private final Command shootSubwoofer = new ShootPiece(m_shooter, m_lights, subShotAngle, subShotRPM, shooterIndexPower, () -> Operator.driver_leftTrigger.getAsBoolean());
    private final Command shootPodium = new ShootPiece(m_shooter, m_lights, podiumShotAngle, podiumShotRPM, shooterIndexPower, () -> Operator.driver_leftTrigger.getAsBoolean());
    private final Command shootWing = new ShootPiece(m_shooter, m_lights, wingShotAngle, wingShotRPM, shooterIndexPower, () -> Operator.driver_leftTrigger.getAsBoolean());
    ...
    private final Command shooterTune = new ShootPiece(m_shooter, m_lights, tuningPosition, tuningPower, shooterIndexPower, () -> Operator.driver_leftTrigger.getAsBoolean());
